...
cat > /tmp/.my.cnf << 'EOF'
[client]
host=$PLAB_DB_HOST_MYSQL
port=3306
user=$PLAB_MYSQL_USER
...
echo "$PLAB_DB_HOST_PG:5432:$PLAB_PG_DB:plab:***REMOVED-CREDENTIAL***" > /tmp/.pgpass
chmod 600 /tmp/.pgpass
PGPASSFILE=/tmp/.pgpass psql -h $PLAB_DB_HOST_PG -p 5432 -U plab -d $PLAB_PG_DB -c "YOUR QUERY;"
rm -f /tmp/.pgpass
```
